...
async function main() {
    ...
    try {
        ...
        /**
         * @changeTheID change the ID
         * @registerNewChaincodeListener initiate a new listening handler to react to chaincode events and prints the event name and payload.
         */
        ...
        /**
         * @createTransaction a transaction listener
         * receives an event when a corresponding transaction is committed to a block
         */
        ...
        /**
         * @setTimeout to make sure that the events submitted are printed
         */
        setTimeout(() => {
            if (`${response}` !== '') {
